		...
		<div id="middle">
			<div id="question"
				...
				<div id="searchquestion">
					<font color="red">查找试题</font>：
					<hr color="red">
					<s:form action="getCurrentPageQuestionListByTeacher.action"
						namespace="/question">
						通过教师查找试题
						<input type="text" name="username" />
						<input type="submit" value="查找">
					</s:form>
					<s:form action="getCurrentPageQuestionListBySubject.action"
						namespace="/question">
						通过科目查找试题
						<input type="text" name="questionsubject" />
						<input type="submit" value="查找">
					</s:form>
					<s:form action="getCurrentPageQuestionListByType.action"
						namespace="/question">
						通过类型查找试题
						<input type="text" name="questiontypeString" />
						<input type="submit" value="查找">
					</s:form>
				</div>
				<hr color="white">
