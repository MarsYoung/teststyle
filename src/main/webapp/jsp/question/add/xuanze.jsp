		...
		<tr>
			...
			<td width="300">
				<div>
					<p>
						<strong>A.</strong>
						<textarea id="a" name="questionselecta" style="width: 400px;"></textarea>
					</p>
					<p>
						<strong>B.</strong>
						<textarea id="b" name="questionselectb" style="width: 400px;"></textarea>
					</p>
					<p>
						<strong>C.</strong>
						<textarea id="c" name="questionselectc" style="width: 400px;"></textarea>
					</p>
					<p>
						<strong>D.</strong>
						<textarea id="d" name="questionselectd" style="width: 400px;"></textarea>
					</p>
				</div>
			</td>
		</tr>
	...
	<div>
		<tr>
			...
			<td width="300">
				<div id="answer">
					<div>
						<textarea name="questionanswer">请输入大写A,B,C,D
</textarea>
					</div>
				</div>
		</tr>
			...
			<td width="300">
				...
				<p>
					<textarea name="questionfrom" rows="10"
						style="width: 400px; height: 100px;">请输入题目来源
</textarea>
				</p>
			</td>
		</tr>
