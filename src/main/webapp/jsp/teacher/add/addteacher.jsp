	...
	<div id="container">
		...
		<div id="middle">
			<div id="register"
				...
				<font color="red" size="20">添加教师</font>
				<hr color="green">
				<s:bean id="loginuser" name="com.mishow.vo.LoginUser" />
				<s:form action="adduser.action" namespace="/user">
					<div id="formcontent">
						<s:textfield name="usertype" label="用户类型" value="TEACHER"
						...
						<s:textfield name="number" label="工号"></s:textfield>
						<s:textfield name="department" label="所在部门"></s:textfield>
						<s:textfield name="subject" label="教授科目"></s:textfield>
					</div>
					<div id="formsubmit">
