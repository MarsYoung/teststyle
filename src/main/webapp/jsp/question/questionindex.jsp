	...
	<div id="container">
		...
		<div id="middle">
			<div id="question"
				...
				<font color="red" size="5px">选择试题分类页面</font>
				<hr color="green">
				<table style="height: auto; width: 200px; margin-right: auto; margin-left: auto; background-color: #D3EBF7;">
				<tr height="50px"><td><a href="/teststyle/jsp/question/majorindex.jsp">1.按照专业选择题目</a></td></tr>
				<tr height="50px"><td><a href="/teststyle/question/getCurrentPageQuestionListOfSearch.action">2.按照教程选择题目</a></td></tr>
				</table>
			</div>
		</div>
		<div id="footer">
